...
List<Product> productList = [
  Product(
    'iPhone 14 Pro Max',
    "L'iPhone 14 Pro Max è uno dei modelli di fascia alta della linea iPhone 2022...",
  ...
  Product(
    'iPhone 14 Pro',
    "L'iPhone 14 Pro è uno dei modelli di fascia alta della linea iPhone 2022...",
  ...
  Product(
    'iPhone 14 Plus',
    "L'iPhone 14 Plus il modello plus della linea di iPhone 2022.Ha un display XDR...",
  ...
  Product(
    'iPhone 14',
    "L'iPhone 14 il modello base della linea di iPhone 2022.Ha un display XDR...",
  ...
  Product(
    'iPhone 13 Mini',
    "L'iPhone 13 Mini è il modello mini della linea di iPhone 2021. Ha un display XDR...",
  ...
  Product(
    'iPhone 13',
    "L'iPhone 13 è il modello base della linea di iPhone 2021. Ha un display XDR...",
  ...
  Product(
    'iPhone 12',
    "L'iPhone 12 è il modello base della linea di iPhone 2020. Ha un display OLED...",
  ...
  Product(
    'iPhone SE 2020',
    "L'iPhone SE (seconda generazione) è uno smartphone più economico di Apple...",
